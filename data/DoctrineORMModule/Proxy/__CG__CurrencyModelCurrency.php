...
namespace DoctrineORMModule\Proxy\__CG__\Currency\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Currency extends \Currency\Model\Currency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'inputFilter', 'id', 'xname', 'code', 'symbol', 'active'];
        }
