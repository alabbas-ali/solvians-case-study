...
namespace DoctrineORMModule\Proxy\__CG__\Issuer\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Issuer extends \Issuer\Model\Issuer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'inputFilter', 'id', 'xname', 'active'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Issuer $proxy) {
    ...
    public function getXname()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getXname', []);

        return parent::getXname();
    }
